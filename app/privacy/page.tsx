...
import { Flame, ArrowLeft, ShieldCheck, Lock, Eye, FileText, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 flex-1">
        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold w-fit mb-6">
        ...
        <div className="space-y-8 text-sm text-slate-300 leading-relaxed">
          <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
              <Eye className="w-5 h-5 text-rose-400" /> 1. Overview &amp; Data Responsibility
            </h2>
            <p>
              Lead Rescue AI (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) respects your privacy and is committed to protecting the personal data of our SaaS users and their prospects. This Privacy Policy describes how we collect, store, process, and disclose information when you access our application at <code className="text-rose-400 bg-slate-950 px-1.5 py-0.5 rounded">https://leadrescueai.xilxil.com</code> and related API endpoints.
            </p>
          </section>
      ...
      <footer className="border-t border-slate-800 py-8 px-6 text-center text-xs text-slate-500">
        &copy; {new Date().getFullYear()} Lead Rescue AI Inc. All rights reserved. | <Link href="/terms" className="hover:text-rose-400 underline">Terms of Service</Link>
      </footer>
    </div>
  );
}
