...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-cyan-500 selection:text-slate-950 flex flex-col font-sans">
      {/* ─── Top Announcement Banner ────────────────────────────────────────────── */}
      <div className="bg-gradient-to-r from-cyan-600 via-purple-600 to-fuchsia-600 text-white text-xs font-semibold py-2 px-4 text-center flex items-center justify-center gap-2">
        ...
        <Link href="/signup" className="underline underline-offset-2 hover:opacity-90 transition-opacity font-bold ml-1 text-white">
          Try Free &rarr;
        </Link>
      </div>
      ...
      <section className="relative pt-20 pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute top-1/3 right-10 w-[400px] h-[400px] bg-purple-500/10 rounded-full blur-3xl pointer-events-none" />

        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs font-semibold mb-8 neon-cyan-glow">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
            <Link
              href="/signup"
              className="w-full sm:w-auto px-8 py-4 rounded-xl rescue-gradient rescue-glow text-slate-950 text-base font-black flex items-center justify-center gap-3 hover:scale-105 transition-transform"
            >
              Start Free 14-Day Trial <ArrowRight className="w-5 h-5" />
            </Link>
            <a
              href="#workflow"
              className="w-full sm:w-auto px-7 py-4 rounded-xl border border-slate-700 hover:border-cyan-500/50 text-slate-200 text-base font-semibold hover:bg-slate-900 transition-all flex items-center justify-center gap-2"
            >
              <BrainCircuit className="w-5 h-5 text-cyan-400" /> Watch Live Demo
            </a>
          </div>
      ...
      <section className="bg-slate-900/60 border-y border-slate-800/80 py-12 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div className="p-4">
            <div className="text-3xl sm:text-4xl font-black text-cyan-400 mb-1">98.4%</div>
            <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider">AI Qualification Accuracy</div>
          </div>
          <div className="p-4">
            <div className="text-3xl sm:text-4xl font-black text-purple-400 mb-1">&lt; 60s</div>
      ...
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Feature 6 */}
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 hover:border-fuchsia-500/40 transition-all">
            <div className="w-12 h-12 rounded-xl bg-fuchsia-500/10 text-fuchsia-400 border border-fuchsia-500/20 flex items-center justify-center mb-5">
      ...
      <section id="workflow" className="bg-slate-900/40 border-y border-slate-800/80 py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="relative text-center p-6 bg-slate-950/60 border border-slate-800 rounded-2xl hover:border-cyan-500/30 transition-all">
            ...
            <div className="relative text-center p-6 bg-slate-950/60 border border-slate-800 rounded-2xl hover:border-purple-500/30 transition-all">
            ...
            <div className="relative text-center p-6 bg-slate-950/60 border border-slate-800 rounded-2xl hover:border-fuchsia-500/30 transition-all">
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto text-center">
        <div className="bg-gradient-to-r from-cyan-950/60 via-slate-900 to-purple-950/60 border border-cyan-500/30 rounded-3xl p-12 relative overflow-hidden shadow-[0_0_50px_rgba(0,240,255,0.1)]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/signup"
              className="px-8 py-3.5 rounded-xl rescue-gradient rescue-glow text-slate-950 text-sm font-black flex items-center gap-2 hover:scale-105 transition-transform"
            >
              Start Your Free Trial <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
              href="/pricing"
              className="px-6 py-3.5 rounded-xl border border-slate-700 hover:border-cyan-500/50 text-slate-300 text-sm font-semibold hover:bg-slate-800 transition-colors"
            >
              View Pricing Tiers
            </Link>
          </div>
      ...
      <footer className="mt-auto bg-slate-950 border-t border-slate-800/80 py-12 px-6 text-xs text-slate-400">
        <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2">
            ...
            <p className="text-slate-400 max-w-sm leading-relaxed mb-4 mt-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/terms" className="hover:text-cyan-400 transition-colors font-medium">Terms of Service</Link></li>
              <li><Link href="/privacy" className="hover:text-cyan-400 transition-colors font-medium">Privacy Policy</Link></li>
              <li><Link href="/privacy#gdpr" className="hover:text-cyan-400 transition-colors">GDPR &amp; CCPA</Link></li>
              <li><Link href="/privacy#security" className="hover:text-cyan-400 transition-colors">Security &amp; SOC2</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:support@leadrescue.ai" className="hover:text-cyan-400 transition-colors">support@leadrescue.ai</a></li>
              <li><a href="mailto:privacy@leadrescue.ai" className="hover:text-cyan-400 transition-colors">privacy@leadrescue.ai</a></li>
            </ul>
          </div>
        </div>
      </footer>
