      ...
      <main className="max-w-5xl mx-auto px-6 py-12 flex-1">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-slate-900/50 border border-slate-800 hover:border-cyan-500/40 transition-all rounded-2xl p-6">
            ...
            <code className="text-[11px] text-cyan-300 bg-slate-950 p-2 rounded-lg block font-mono border border-cyan-500/20">
          ...
          <div className="bg-slate-900/50 border border-slate-800 hover:border-purple-500/40 transition-all rounded-2xl p-6">
            ...
            <code className="text-[11px] text-purple-300 bg-slate-950 p-2 rounded-lg block font-mono border border-purple-500/20">
              POST /api/v1/rag/knowledge
            </code>
          </div>

          <div className="bg-slate-900/50 border border-slate-800 hover:border-emerald-500/40 transition-all rounded-2xl p-6">
            ...
            <code className="text-[11px] text-emerald-300 bg-slate-950 p-2 rounded-lg block font-mono border border-emerald-500/20">
