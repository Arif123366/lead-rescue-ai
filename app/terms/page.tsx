    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-cyan-500 selection:text-slate-950">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 flex-1">
        ...
        <div className="space-y-8 text-sm text-slate-300 leading-relaxed">
          <section className="bg-slate-900/50 border border-slate-800 hover:border-cyan-500/30 transition-all rounded-2xl p-6">
          ...
          <section className="bg-slate-900/50 border border-slate-800 hover:border-purple-500/30 transition-all rounded-2xl p-6">
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
          ...
          <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
            ...
            <div className="bg-slate-950/60 p-3.5 rounded-xl border border-cyan-500/20 text-xs text-slate-400">
